...
|--------|---------|-------------|
| Status | `gong-module-run remote --status` | Check remote connection status; automatically opens Pod Watch if the environment is sleeping |
| Connect | `gong-module-run remote --connect` | Connect to the remote environment; automatically opens Pod Watch if the environment is sleeping |
